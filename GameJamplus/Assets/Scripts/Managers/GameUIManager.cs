...
public class GameUIManager : Singleton<GameUIManager>
{
    ...
    public void EnteringWitchUIColor(PlayerBehaviour player)
    {
        ...
        playersUIs[playerpos].HeroBG.color = player.GetCharacterInfo().Color;
    ...
    public void UpdateUISkillCD(int position)
    {
        ...
        if (_cd > GameDataManager.Data.SwitchCooldown)
        {
            ...
            playersUIs[position].CooldownFillImg.color = playerList[position].GetComponent<PlayerBehaviour>().GetCharacterInfo().Color;
        }
        else
        {
